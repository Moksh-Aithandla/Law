...
async function initApp() {
  ...
  if (viewCasesBtn) {
    viewCasesBtn.addEventListener('click', showAllCases);
  }
  
  if (viewBlockchainBtn) {
    viewBlockchainBtn.addEventListener('click', showBlockchainInfo);
  }
  ...
  if (backToCasesBtn) {
    backToCasesBtn.addEventListener('click', showAllCases);
  }
  
  if (backToHomeFromBlockchainBtn) {
    backToHomeFromBlockchainBtn.addEventListener('click', showHome);
  }
