...
// This file handles interactions with Ethereum blockchain (Sepolia testnet) and IPFS
...
const CONTRACT_ADDRESS = '0x123456789abcdef123456789abcdef123456789a'; // Replace with actual contract address after deployment
const ALCHEMY_API_KEY = 'RuOilkGBfCJflqOLZND0WrLWvLFtooRA';

// Contract ABI - will be replaced with actual ABI after contract compilation
const CONTRACT_ABI = [
  {
    "inputs": [],
...
async function initBlockchain() {
  try {
    ...
    if (window.ethereum) {
      ...
      evaultContract = new ethers.Contract(CONTRACT_ADDRESS, CONTRACT_ABI, signer);
